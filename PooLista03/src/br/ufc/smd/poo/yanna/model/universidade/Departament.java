...
public class Departament {
	...
	// TODO add remove professor method
	...
	public void addCourse(long code, String name, String shift, long totalHours) {
		...
		if (isCourse(code)) {
			System.err.println("[DEPARTAMENT] Course with code '"+ code + "' was already on the courses list of " + this.acronym + ". It wasn't added.");
		} else {
			Course course = new Course(code, name, null, shift, totalHours);
			courses.add(course);
			System.out.println("[DEPARTAMENT] Course '"+ course.getName() + "' added succefully to the courses list of " + this.acronym + "!");
			if (course.getDepartament() != this) {
				course.setDepartament(this);
			}
		}
	}
	...
	public void addCourse(Course course) {
		if (course == null) {
			throw new NullPointerException("null course is not allowed");
		}
		if (isCourse(course)) {
			System.err.println("[DEPARTAMENT] Course '"+ course.getName() + "' was already on the courses list of " + this.acronym + ". It wasn't added.");
		} else {
			courses.add(course);
			System.out.println("[DEPARTAMENT] Course '"+ course.getName() + "' added succefully to the courses list of " + this.acronym + "!");
			if (course.getDepartament() != this) {
